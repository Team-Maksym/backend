/*DROP TABLE SAMPLEDB.PUBLIC.POSITION_ENTITY;
DROP TABLE SAMPLEDB.PUBLIC.TALENT_ENTITY;
DROP TABLE talent_entity_authorities;
...
CREATE TABLE talent_entity_authorities
(
    talent_entity_talent_id BIGINT NOT NULL,
    talent_entity_authorities_id  BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    authorities  VARCHAR(255),
    CONSTRAINT pk_talententityauthorities PRIMARY KEY (talent_entity_authorities_id)
);
...
ALTER TABLE talent_entity_authorities
    ADD CONSTRAINT fk_talpos_on_pk_talent_entity_authorities FOREIGN KEY (talent_entity_authorities_id) REFERENCES talent_entity_authorities (talent_entity_authorities_id);