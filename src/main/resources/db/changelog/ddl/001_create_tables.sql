...
ALTER TABLE users
    ADD CONSTRAINT FK_USER_ON_SPONSOR FOREIGN KEY (sponsor_id) REFERENCES sponsor (sponsor_id);

ALTER TABLE users
    ADD CONSTRAINT FK_USER_ON_TALENT FOREIGN KEY (talent_id) REFERENCES talent (talent_id);