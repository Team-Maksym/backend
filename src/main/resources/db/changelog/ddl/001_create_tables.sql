...
ALTER TABLE kudos_entity
    ADD CONSTRAINT FK_KUDOSENTITY_ON_OWNER FOREIGN KEY (owner) REFERENCES user_entity (user_id);

ALTER TABLE kudos_entity
    ADD CONSTRAINT FK_KUDOSENTITY_ON_PROOF FOREIGN KEY (proof) REFERENCES proof_entity (proof_id);